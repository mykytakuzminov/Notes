// MARK: - Struct
// Структура создаёт новый тип данных, который является значимым типом.

// MARK: - Инициализация структуры
struct Person {
    ...
    // MARK: Хранимые свойства структуры
    var name: String
    var surname: String
    var age: Int
    
    // MARK: Вычесляемые свойства структуры
    var isAdult: Bool {
        age >= 18 ? true : false
    }
    ...
    // MARK: - Инициализаторы структуры
    // Структуры имеют инициализатор по умолчанию
    ...
    // MARK: Мутирующие методы структуры
    mutating func change(name: String) {
        self.name = name
    }
    
    mutating func change(surname: String) {
        self.surname = surname
    }
}

// MARK: - Создание объекта
var person = Person(name: "John", surname: "Smith", age: 25, passportID: "197843")

// MARK: - Доступ к свойствам и методам объекта структуры
